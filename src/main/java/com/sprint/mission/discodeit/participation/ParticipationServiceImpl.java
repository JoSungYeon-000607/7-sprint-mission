...
@Service
public class ParticipationServiceImpl extends
    BaseServiceImpl<Participation, ParticipationDualKey, ParticipationRepository> implements
  ...
  @Override
  public Participation joinChannel(ParticipationRequestDTO requestDTO, UUID userId) {
...
//  }
  ...
  @Override
  public ParticipationResponseDTO findByTempId(UUID tempId) {
    return ParticipationResponseDTO.from(repository.findByTempId(tempId));
  }
